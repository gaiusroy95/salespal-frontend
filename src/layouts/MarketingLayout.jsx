    ...
    return (
        <div className="flex h-screen bg-gray-50 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header aria-label="Marketing top bar" className="h-14 md:h-16 bg-white border-b border-gray-200 px-3 md:px-6 flex items-center justify-between gap-2 shrink-0 sticky top-0 z-20 overflow-visible">
                ...
                {/* Content Area */}
                <main id="marketing-main-content" className="flex-1 overflow-auto p-4 md:p-6 lg:p-8">
